...
function ServiceCard({
  ...
  return (
    <motion.article
      ...
      className="group flex h-[350px] flex-col overflow-hidden rounded-xl border border-slate-200/70 bg-white shadow-sm transition-all duration-500 hover:-translate-y-1 hover:border-brand/20 hover:shadow-[0_18px_50px_rgba(15,23,42,0.08)]"
    >
      {/* IMAGE */}
