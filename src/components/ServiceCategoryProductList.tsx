...
import { featureBadgesFromSpecs, type ServiceCatalogCategory } from "@/data/serviceProductLists";
...
export default function ServiceCategoryProductList({ category, serviceLabel }: Props) {
  return (
        ...
        {category.items.map((item) => (
          <motion.div key={item.slug} variants={cardMotion} className="h-full">
            <CatalogCard
              ...
              featureBadges={featureBadgesFromSpecs(item.specs)}
