...
const licenseCatalogInput: ServiceCatalogCategoryInput[] = [
  {
    ...
    items: [
      ...
      card("Windows 11", "windows", "win", "Windows 11 licensing", "Windows 11", SL, "Microsoft", SL_LINE, [
        ...
        "Pro OEM, retail, and volume licensing",
        "Upgrade path from Windows 10",
        "Activation and imaging support",
        "Licence details on tax invoice",
      ]),
      card("Microsoft Azure", "server", "azure", "Microsoft Azure licensing", "Microsoft Azure", SL, "Microsoft", SL_LINE, [
        "Microsoft Azure — cloud platform",
        "Compute, storage, and networking subscriptions",
        "Pay-as-you-go and commitment plans",
        "Advisory on sizing and cost control",
        "Billing aligned to your tenant",
      ]),
      card("Microsoft Teams", "m365", "teams", "Microsoft Teams licensing", "Microsoft Teams", SL, "Microsoft", SL_LINE, [
        ...
        "Standalone or Microsoft 365 bundled",
        "Phone System and calling plans quoted separately",
        "Guest access and policy guidance",
        "User onboarding assistance",
      ]),
      card("OneDrive", "m365", "onedrive", "Microsoft OneDrive licensing", "OneDrive", SL, "Microsoft", SL_LINE, [
        "OneDrive — cloud file storage",
        "Included in Microsoft 365 or standalone plans",
        "Business and enterprise storage tiers",
        "Sync client deployment support",
        "Retention and sharing policies explained",
      ]),
      ...
      card("Dynamics 365", "office", "d365", "Dynamics 365 licensing", "Dynamics 365", SL, "Microsoft", SL_LINE, [
        ...
        "Sales, Customer Service, Finance & Operations modules",
        "Cloud subscription licensing",
        "Implementation partner coordination on request",
        "User and device CAL guidance",
      ]),
      card("Xbox Game Pass", "globe", "xbox", "Xbox Game Pass licensing", "Xbox Game Pass", SL, "Microsoft", SL_LINE, [
        ...
        "PC Game Pass and Ultimate tiers",
        "Corporate gifting and staff perk programmes",
        "Redemption and account setup support",
        "GST documentation for procurement",
      ]),
    ],
  },
  {
